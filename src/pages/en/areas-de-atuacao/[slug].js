                ...
                <div className="container px-5 px-sm-0">
                    <div className="row">
                        <div className="col-4 d-none d-md-block">
                            <strong className="d-block text-escuro playfair ps-3 fs-24 mb-4">Areas of Expertise</strong>
                                    ...
                                    areas.map(area => {
                                        return (
                                            <li className="list-group-item" key={area.slug}>
                                                <Link scroll={false} href={`/${textos.locale.substring(0, 2)}/areas-de-atuacao/${area.icon}`}>
                                                    <a className=" d-inline-flex justify-content-between align-items-center w-100" id={`${area.icon}`}>
                                    ...
                                    <nav className="navbar navbar-light mb-4 d-block d-md-none">
                                        <div className="container-fluid p-0">
                                            <div className="mb-3 w-100 d-flex align-items-center justify-content-between">
                                                <span className="fs-24 text-dourado playfair area-nav-title">Select an <br /> Area of Expertise</span>
                        ...
                        <div className="row m-0">
                            ...
                            <div className="col-12 col-md-8">
                                <div className="bg-dourado estamos-prontos flex-wrap">
                                    ...
                                    <a href="#banner-inferior" className="btn btn-secondary btn-h-50">Speak With an Attorney</a>
                                </div>
                            </div>
                        </div>
