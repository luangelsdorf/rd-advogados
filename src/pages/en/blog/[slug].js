                    ...
                    <div className="col-10">
                        ...
                        <div>
                            ...
                            <div className="fs-20 text-escuro">
                                <span className="d-block">Did you like the post?</span>
                                <span className="d-block">Share on Social Meida:</span>
                ...
                <div className="row gy-4 text-center align-items-center" id="related">
                    ...
                    <div className="col-12 col-lg-6 d-flex justify-content-lg-end justify-content-center">
                        <Link href={`/${contact.locale.substring(0, 2)}/blog`}>
                            <a className="btn btn-primary btn-h-50 d-inline-flex justify-content-center" id="ver-todas">See All Posts<img src="/img/seta.svg" alt="Seta" /></a>
                        </Link>
                    </div>
                </div>
