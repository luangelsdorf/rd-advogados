    ...
    <header className="top-header" id="home">
      <div>
        <div className="container top-bar d-flex justify-content-end text-white">
          <div className="bar-section my-2">
            <a href={`tel:51 3031.7222`} className="fs-13 pe-3 divisor"><strong>Fone</strong>: 51 3031.7222</a>
            <a href={`mailto:contato@rdsa.adv.br`} className="fs-13 px-3 divisor"><strong>Email</strong>: contato@rdsa.adv.br</a>
          </div>
          <div className="bar-section my-2">
            <div className="fs-13 ps-3">
              <a href={'https://www.facebook.com/RDAdvogadoscanoas/'} className="bar-link pe-2">
              ...
              <a href={'https://www.instagram.com/rossiedorneles/'} className="bar-link">
      ...
      <nav className="navbar navbar-top navbar-expand-xl navbar-light w-100">
        <div className="container">
          ...
          <Link href="#banner-inferior">
            <a className="btn btn-primary hover-claro d-none d-xl-inline-flex px-3 btn-h-40">{'Fale com um Advogado'}</a>
          </Link>
        </div>
      </nav>
    </header>
