  ...
  return (
    <div className="newsletter mx-3 mx-sm-0">
      <div>
        ...
        <span className="playfair fs-20 d-md-none d-block">{'Assine nossa Newsletter'}</span>
        <span className="text-white d-none d-md-inline-block my-4">{'Inscreva-se para receber nossas últimas notícias e artigos.'}</span>
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            <input onChange={(e) => { setEmail(e.target.value) }} required="required" type="email" className="form-control news-input" placeholder={'Insira seu E-mail'} />
            <button className="btn btn-primary news-submit justify-content-center" type="submit" disabled={submitted}>
          ...
          <div className="flex-center w-max-content mt-2 mt-sm-0" id="subscribed">
            ...
            <span className="d-inline-block text-white ms-2 fs-13">{'Enviada com sucesso!'}</span>
          </div>
