...
export default function Qualidades({ textos, contact }) {
  return (
    <div className="text-center text-lg-start">
      <img src="/img/logo-symbol.svg" alt="Logo" className="d-block mx-auto mx-lg-0" />

      <span className="qualidades">
        {'Se você precisa resolver algo saiba que o nosso objetivo é facilitar a sua vida'}
      </span>

      <div className="d-flex justify-content-center justify-content-lg-start">
        <a href={'https://www.facebook.com/RDAdvogadoscanoas/'} className="social-btn me-2">
        ...
        <a href={'https://www.instagram.com/rossiedorneles/'} className="social-btn">
